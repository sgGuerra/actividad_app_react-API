...
exports.TheSportsDBService = void 0;
...
class TheSportsDBService {
    ...
    async searchPlayers(name) {
        const data = await this.fetchJSON(`searchplayers.php?p=${encodeURIComponent(name)}`);
        return data.player || [];
    }
    /**
     ...
     */
    async lookupFormerTeams(playerId) {
     ...
     */
    async lookupContracts(playerId) {
     ...
     */
    async lookupMilestones(playerId) {
    ...
    async searchTeams(name) {
        const data = await this.fetchJSON(`searchteams.php?t=${encodeURIComponent(name)}`);
        return data.teams || [];
    }
    /**
    ...
    async getTeamsByLeague(league) {
        const data = await this.fetchJSON(`search_all_teams.php?l=${encodeURIComponent(league)}`);
        return data.teams || [];
    }
}
exports.TheSportsDBService = TheSportsDBService;
//# sourceMappingURL=TheSportsDBService.js.map